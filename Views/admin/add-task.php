    ...
    <div class="container-fluid">
      <div class="card card-default">
        <div class="card-header">
          <a href="<?= base_url(ADMINPATH . 'task-list') ?>" class="btn btn-success m-auto"
            style="float:right;position:relative;">
          View Tasks
          </a>
        </div>
        <div class="card-header">
          <?php echo form_open(ADMINPATH . 'save-task', 'enctype="multipart/form-data"'); ?>
          <?=form_hidden('id',$id)?>
          <div class="form-group row mt-2">
            <?=form_label('Task Name <span class="text-danger">*</span>','task_name',['class'=>'col-sm-2 col-form-label'])?>
            <div class="col-sm-4">
              <?= form_input(['name' => 'task_name','autocomplete'=>'off', 'required' => 'required', 'placeholder' => 'Enter Task Name', 'id' => 'task_name', 'class' => 'form-control ucwords restrictedInput','value'=>$task_name]); ?>
            </div>
          </div>
          <div class="form-group row mt-2">
