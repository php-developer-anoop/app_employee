    ...
    <div class="container-fluid">
      <div class="card card-default">
        <div class="card-header">
          <a href="<?= base_url(ADMINPATH . 'district-list') ?>" class="btn btn-success m-auto"
            style="float:right;position:relative;">
          View Districts
          </a>
        </div>
        <div class="card-header">
          <?php echo form_open(ADMINPATH . 'save-district', 'enctype="multipart/form-data"'); ?>
          <?=form_hidden('id',$id)?>
          ...
          <div class="col-sm-4">
            ...
            <div class="col-sm-4">
            <?=form_label('District Name <span class="text-danger">*</span>','district_name',['class'=>'col-form-label'])?>
              <?= form_input(['name' => 'district_name','autocomplete'=>'off','required' => 'required', 'placeholder' => 'Enter District Name', 'id' => 'district_name', 'class' => 'form-control ucwords restrictedInput','value'=>$district_name]); ?>
            </div>
