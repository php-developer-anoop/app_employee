...
<script>
    ...
    function loadAllRecordsData(qparam) {
        ...
        $('#responseData').DataTable({
            ...
            { data: "", "name": "Cms Detail", "title": "Cms Detail","render":cms },
...
var cms = ( data, type, row, meta )=>{
  var data = '';
  let page_type= row.page_type!=null?row.page_type:"";
  let title= row.title!=null?row.title:"";
  if(type === 'display'){
        data += '<span class="fotr_10"><b>Title : </b>'+title+'</span><br>' ;
        data += '<span class="fotr_10"><b>Page Type : </b>'+page_type+'</span>' ;
...
return data;
    ...
    function action_render(data, type, row, meta) {
        ...
        if (type === 'display') {
            ...
            var onclick = "remove('" + row.id + "','dt_cms_list')";
