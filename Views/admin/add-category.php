    ...
    <div class="container-fluid">
      <div class="card card-default">
        <div class="card-header">
          <a href="<?= base_url(ADMINPATH . 'category-list') ?>" class="btn btn-success m-auto"
            style="float:right;position:relative;">
          View Categories
          </a>
        </div>
        <div class="card-header">
          <?php echo form_open(ADMINPATH . 'save-category', 'enctype="multipart/form-data"'); ?>
          <?=form_hidden('id',$id)?>
          <div class="form-group row mt-2">
            <?=form_label('Category Name <span class="text-danger">*</span>','category_name',['class'=>'col-sm-2 col-form-label'])?>
            <div class="col-sm-4">
              <?= form_input(['name' => 'category_name','autocomplete'=>'off', 'required' => 'required', 'placeholder' => 'Enter Category Name', 'id' => 'category_name', 'class' => 'form-control','value'=>$category_name]); ?>
            </div>
          </div>
          <div class="form-group row mt-2">
