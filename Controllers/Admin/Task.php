...
class Task extends BaseController {
    ...
    public function getRecords() {
        ...
        if (!empty($get["search"]["value"])) {
            ...
            $where[" task_name LIKE '%" . $searchString . "%'"] = null;
            $limit = 100;
            $start = 0;
        }
