...
class Cms extends BaseController {
    ...
    public function save_cms() {
        ...
        $id = !empty($this->request->getVar('id')) ? $this->request->getVar('id') : '';
        $data = [];
        $data['page_type'] = (trim($post['page_type']));
