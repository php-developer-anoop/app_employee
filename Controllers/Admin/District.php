...
class District extends BaseController {
    ...
    public function __construct() {
        ...
        $this->table = "dt_district";
    }
    function index() {
        $data = [];
        $data["title"] = "District Master";
        adminview('view-district', $data);
    }
    function add_district() {
        $id = !empty($this->request->getVar('id')) ? $this->request->getVar('id') : '';
        $data = [];
        $data["title"] = !empty($id) ? "Edit District" : "Add District";
    ...
    public function getRecords() {
        ...
        if (!empty($get["search"]["value"])) {
            ...
            $where[" district_name LIKE '%" . $searchString . "%' OR state_name LIKE '%" . $searchString . "%'"] = null;
            $limit = 100;
            $start = 0;
        }
