...
class Duty_on extends BaseController {
    ...
    public function index() {
        ...
        $duty = $this->model->getSingle("employee_list", 'duty_status,last_duty_id', ['profile_status' => 'Active', 'id' => $employee_id]);
        if (empty($duty)) {
            $response['status'] = false;
        ...
        if ($last_id) {
            $this->model->updateRecords("employee_list", ['last_duty_id' => $last_id, 'duty_status' => 'on'], ['id' => $employee_id, 'profile_status' => 'Active']);
    ...
    public function duty_off() {
        ...
        $this->model->updateRecords("employee_list", ['duty_status' => 'off', 'last_duty_id' => ''], ['id' => $employee_id]);
        $response['status'] = TRUE;
