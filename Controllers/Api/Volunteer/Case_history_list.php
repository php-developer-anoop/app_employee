...
class Case_history_list extends BaseController {
    ...
    public function index() {
        ...
        $keys = '*';
        $case_history_list = $this->model->getAllData('case_history', $keys, $where, $limit, $start);
    ...
    public function case_history_detail(){
        ...
        $value=$this->model->getSingle('case_history','*',['id'=>$id,'employee_id'=>$employee_id,'volunteer_id'=>$volunteer_id]);
        if(empty($value)){
            $response["status"] = false;
